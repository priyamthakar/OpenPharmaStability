...
`OpenPharmaStability.dc.html` is a static public landing page for the
project. It presents the product story, a mock local workspace, the design
system, and links to real sample outputs from the Python engine.
...
To preview locally, serve the repository root and open the page in a browser:
