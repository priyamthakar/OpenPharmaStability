...
pharmaceutical development. **v1.1.0** is the current release. The v0.1
...
> [`NEXT_STEPS.md`](NEXT_STEPS.md) §11 before editing the public surface.
...
v1.1.0 is the current release. The stats engine remains in Python
