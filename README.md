...
pharmaceutical development. **v1.0.0** is the current release. The v0.1
...
The full suite is expected to collect **469 tests** after v1.0.0
...
v1.0.0 is the current release. The stats engine remains in Python
