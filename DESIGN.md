...
> **NOTE:** This is a reference design spec for the **v0.7.0+ UI
> pass** (Cloudflare Pages + Claude Design polish). It is not used
> by any v0.6.0 code. See `NEXT_STEPS.md` §11.
